...
switch (object) {
case Metadata_PositionEncoding.POSITION_ENCODING_UNSPECIFIED: return "POSITION_ENCODING_UNSPECIFIED";
case Metadata_PositionEncoding.POSITION_ENCODING_UTF8: return "POSITION_ENCODING_UTF8";
case Metadata_PositionEncoding.POSITION_ENCODING_UTF16: return "POSITION_ENCODING_UTF16";
...
switch (object) {
case Symbol_Unique.UNIQUE_UNSPECIFIED: return "UNIQUE_UNSPECIFIED";
case Symbol_Unique.UNIQUE_DOCUMENT: return "UNIQUE_DOCUMENT";
case Symbol_Unique.UNIQUE_GLOBAL: return "UNIQUE_GLOBAL";
default: return "UNKNOWN";
}
}
...
switch (object) {
case Occurrence_Role.ROLE_UNSPECIFIED: return "ROLE_UNSPECIFIED";
case Occurrence_Role.ROLE_DEFINITION: return "ROLE_DEFINITION";
case Occurrence_Role.ROLE_REFERENCE: return "ROLE_REFERENCE";
default: return "UNKNOWN";
}
}
...
switch (object) {
case Occurrence_Highlight.HIGHLIGHT_UNSPECIFIED: return "HIGHLIGHT_UNSPECIFIED";
case Occurrence_Highlight.HIGHLIGHT_STRING_LITERAL: return "HIGHLIGHT_STRING_LITERAL";
case Occurrence_Highlight.HIGHLIGHT_NUMERIC_LITERAL: return "HIGHLIGHT_NUMERIC_LITERAL";
case Occurrence_Highlight.HIGHLIGHT_IDENTIFIER: return "HIGHLIGHT_IDENTIFIER";
case Occurrence_Highlight.HIGHLIGHT_METHOD_IDENTIFIER: return "HIGHLIGHT_METHOD_IDENTIFIER";
case Occurrence_Highlight.HIGHLIGHT_TYPE_IDENTIFIER: return "HIGHLIGHT_TYPE_IDENTIFIER";
case Occurrence_Highlight.HIGHLIGHT_TERM_IDENTIFIER: return "HIGHLIGHT_TERM_IDENTIFIER";
case Occurrence_Highlight.HIGHLIGHT_LOCAL_IDENTIFIER: return "HIGHLIGHT_LOCAL_IDENTIFIER";
case Occurrence_Highlight.HIGHLIGHT_SHADED_IDENTIFIER: return "HIGHLIGHT_SHADED_IDENTIFIER";
case Occurrence_Highlight.HIGHLIGHT_PACKAGE_IDENTIFIER: return "HIGHLIGHT_PACKAGE_IDENTIFIER";
default: return "UNKNOWN";
}
}
...
externalSymbols: Array.isArray(object?.externalSymbols) ? object.externalSymbols.map((e: any) => Symbol.fromJSON(e)): [],
};
},
...
fromJSON(object: any): Metadata {
      return {
toolInfo: isSet(object.toolInfo)
          ? ToolInfo.fromJSON(object.toolInfo)
          : undefined,
projectRoot: isSet(object.projectRoot)
          ? String(object.projectRoot)
          : "",
...
toJSON(message: Metadata): unknown {
      const obj: any = {};
message.toolInfo !== undefined && (obj.toolInfo = message.toolInfo ? ToolInfo.toJSON(message.toolInfo) : undefined);
message.projectRoot !== undefined && (obj.projectRoot = message.projectRoot);
message.positionEncoding !== undefined && (obj.positionEncoding = metadata_PositionEncodingToJSON(message.positionEncoding));
return obj;
},
...
fromJSON(object: any): Document {
      return {
uri: isSet(object.uri)
          ? String(object.uri)
          : "",
occurrences: Array.isArray(object?.occurrences) ? object.occurrences.map((e: any) => Occurrence.fromJSON(e)): [],
...
unique: isSet(object.unique)
          ? symbol_UniqueFromJSON(object.unique)
          : 0,
documentation: Array.isArray(object?.documentation) ? object.documentation.map((e: any) => String(e)): [],
packageUri: isSet(object.packageUri)
          ? String(object.packageUri)
          : "",
referenceSymbols: Array.isArray(object?.referenceSymbols) ? object.referenceSymbols.map((e: any) => String(e)): [],
implementationSymbols: Array.isArray(object?.implementationSymbols) ? object.implementationSymbols.map((e: any) => String(e)): [],
};
},
...
symbolUri: isSet(object.symbolUri)
          ? String(object.symbolUri)
          : "",
symbolRole: isSet(object.symbolRole)
          ? occurrence_RoleFromJSON(object.symbolRole)
          : 0,
symbolDocumentation: Array.isArray(object?.symbolDocumentation) ? object.symbolDocumentation.map((e: any) => String(e)): [],
highlight: isSet(object.highlight)
          ? occurrence_HighlightFromJSON(object.highlight)
          : 0,
};
},

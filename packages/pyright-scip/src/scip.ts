...
export namespace scip {
    ...
    export class Metadata extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.text_document_encoding !== undefined) writer.writeEnum(4, this.text_document_encoding);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class ToolInfo extends pb_1.Message {
        ...
        static fromObject(data: { name?: string; version?: string; arguments?: string[] }) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.arguments !== undefined) writer.writeRepeatedString(3, this.arguments);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class Document extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (typeof this.language === 'string' && this.language.length) writer.writeString(4, this.language);
    ...
    export class Symbol extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (typeof this.scheme === 'string' && this.scheme.length) writer.writeString(1, this.scheme);
            if (this.package !== undefined) writer.writeMessage(2, this.package, () => this.package.serialize(writer));
    ...
    export class Package extends pb_1.Message {
        ...
        static fromObject(data: { manager?: string; name?: string; version?: string }) {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (typeof this.manager === 'string' && this.manager.length) writer.writeString(1, this.manager);
    ...
    export class Descriptor extends pb_1.Message {
        ...
        static fromObject(data: { name?: string; disambiguator?: string; suffix?: Descriptor.Suffix }) {
    ...
    export class SymbolInformation extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (typeof this.symbol === 'string' && this.symbol.length) writer.writeString(1, this.symbol);
            if (this.documentation !== undefined) writer.writeRepeatedString(3, this.documentation);
    ...
    export class Relationship extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (typeof this.symbol === 'string' && this.symbol.length) writer.writeString(1, this.symbol);
            if (this.is_reference !== undefined) writer.writeBool(2, this.is_reference);
            if (this.is_implementation !== undefined) writer.writeBool(3, this.is_implementation);
            if (this.is_type_definition !== undefined) writer.writeBool(4, this.is_type_definition);
            if (!w) return writer.getResultBuffer();
        }
    ...
    export class Occurrence extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (typeof this.symbol === 'string' && this.symbol.length) writer.writeString(2, this.symbol);
            if (this.symbol_roles !== undefined) writer.writeInt32(3, this.symbol_roles);
            if (this.override_documentation !== undefined) writer.writeRepeatedString(4, this.override_documentation);
    ...
    export class Diagnostic extends pb_1.Message {
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.severity !== undefined) writer.writeEnum(1, this.severity);
            if (typeof this.code === 'string' && this.code.length) writer.writeString(2, this.code);
            if (typeof this.message === 'string' && this.message.length) writer.writeString(3, this.message);
            if (typeof this.source === 'string' && this.source.length) writer.writeString(4, this.source);
            if (this.tags !== undefined) writer.writePackedEnum(5, this.tags);
            if (!w) return writer.getResultBuffer();
        }
